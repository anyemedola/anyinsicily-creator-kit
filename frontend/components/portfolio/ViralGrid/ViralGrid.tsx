...
const viralContent = [
  ...
  { video: '/videos/video4.mp4', badge: 'Growing', views: '110k+', topic: '"In Italy we say..." — culture & humor', gradient: 'linear-gradient(160deg, #2a1a2a 0%, #1a0d1a 100%)' },
  { video: '/videos/video3.mp4', badge: 'Growing', views: '20k+', topic: '"In Germany they say..." — culture & humor', gradient: 'linear-gradient(160deg, #1a2a1a 0%, #0d1a0d 100%)' },
];
